...
<head>
    ...
    <meta charset="utf-8">
    <title>BestBalo - Chi tiết sản phẩm</title>
                            ...
                            <div class="tf-product-info-wrap sticky-top">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-pickup-availability mt-5">
                                        ...
                                        <div>
                                            <p>Nhận hàng tại <span class="fw-6">Thành phố Hà Nội</span> sẵn sàng trong 24 giờ</p>
                                            <a href="#pickup_available" data-bs-toggle="modal" class="">
                                            Kiểm tra tình trạng còn hàng tại các cửa hàng khác                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-product-info-extra-link">
                                        ...
                                        <a href="#delivery_return" data-bs-toggle="modal" class="tf-product-extra-icon">
                                            ...
                                            <div class="text fw-6">Vận chuyển &amp; Trở lại</div>
                                        </a>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-12">
                                                <div class="tf-product-delivery">
                                                    ...
                                                    <p>ước tính thời gian giao hàng <span class="fw-7">12-26 ngày</span> (quốc tế), <span class="fw-7">3-6 ngày</span> (Hoa kỳ).</p>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-12">
                                    ...
                                    <div class="tf-product-info-trust-seal">
                                        <div class="tf-product-trust-mess">
                                            <i class="icon-safe"></i>
                                            <p class="fw-6">An toàn <br> Thanh toán</p>
                                        </div>
                                    ...
                                    <div class="tf-mini-cart-bottom-wrap">
                                        ...
                                        <div class="tf-cart-checkbox">
                                            ...
                                            <label for="CartDrawer-Form_agree">
                                                Tôi đồng ý với
                                                <a href="#" title="Terms of Service">Điều khoản</a>
                                            </label>
                                        </div>
                                        <div class="tf-mini-cart-view-checkout">
                                            <a href="?act=shopping-cart" class="tf-btn btn-outline radius-3 link w-100 justify-content-center">View cart</a>
                                    ...
                                    <form class="tf-product-form-addgift">
                                        <div class="tf-mini-cart-tool-content">
                                            ...
                                            <div class="tf-cart-tool-btns">
                                                <div class="tf-mini-cart-tool-primary text-center w-100 fw-6 tf-mini-cart-tool-close">Hủy</div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="tf-mini-cart-tool-openable estimate-shipping">
                                    ...
                                    <div class="tf-mini-cart-tool-content">
                                        <div class="tf-mini-cart-tool-text">
                                            ...
                                            <span class="fw-6">ước tính vận chuyển</span>
                                        </div>
                                        <div class="field">
                                            <p>Quốc Gia</p>
                    ...
                    <div class="col-12">
                        <div class="widget-tabs style-has-border">
                            <ul class="widget-menu-tab">
                                ...
                                <li class="item-title">
                                    <span class="inner">kiểm tra</span>
                                </li>
                                <li class="item-title">
                                    ...
                                    <div class="tab-reviews write-cancel-review-wrap">
                                        ...
                                        <div class="reply-comment cancel-review-wrap">
                                            <div class="d-flex mb_24 gap-20 align-items-center justify-content-between flex-wrap">
                                                <h5 class=""><?= count($comment) ?> Chú thích</h5>
                                                <div class="d-flex align-items-center gap-12">
                                                    <div class="text-caption-1">Sắp xếp theo:</div>
                                                    <div class="tf-dropdown-sort" data-bs-toggle="dropdown">
                                                        <div class="btn-select">
                                                            <span class="text-sort-value">Gần đây nhất</span>
                                                            <span class="icon icon-arrow-down"></span>
                                                        </div>
                                                        <div class="dropdown-menu">
                                                            <div class="select-item active">
                                                                <span class="text-value-item">Gần đây nhất</span>
                                                            </div>
                    ...
                    <?php foreach ($otherProduct as $key => $value): ?>
                        <div class="card-product fl-item" style="display: block;">
                            ...
                            <div class="card-product-info">
                                <a href="http://localhost/xuongduan1/?act=product-detail&amp;product_id=17" class="title link">
                                    <?= $value->name ?>
                                </a>
