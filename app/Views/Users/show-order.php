            ...
            <table class="tf-table-page-cart">
                ...
                <?php foreach($orders as $key => $value): ?>
                    <tr>
                        ...
                        <?php elseif ($value->status == 'packed'): ?>
                            <span class="badge text-bg-info">Đã đóng gói</span>
                        <?php elseif ($value->status == 'shipped'): ?>
                            <span class="badge text-bg-secondary">Đã giao hàng</span>
                        <?php elseif ($value->status == 'shipping'): ?>
                            <span class="badge text-bg-primary">Đang giao hàng</span>
                        <?php elseif ($value->status == 'delivered'): ?>
                            <span class="badge text-bg-success">Đã giao đến nơi</span>
